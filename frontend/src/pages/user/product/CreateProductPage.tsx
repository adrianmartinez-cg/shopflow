...
import {
  VALIDATION_POSITIVE_NUMBER_FIELD,
  VALIDATION_REQUIRED_FIELD_MSG,
          ...
          <Controller
            ...
            render={({ field }) => (
              <InputNumber
                ...
                className="w-full p-lara-dark-blue"
                mode="currency"
                currency="BRL"
                minFractionDigits={2}
                maxFractionDigits={2}
                ...
                emptyTemplate={
                  <div className="flex flex-col items-center">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Drop and drag images or click select the images.
                    </p>
                  </div>
                }
                uploadHandler={(e) => {
                ...
                onRemove={(e) => {
                  if (value) {
                    const newFiles = value.filter(
                      (file: File) => file.name !== e.file.name,
                    );
                    onChange(newFiles);
                  }
                }}
